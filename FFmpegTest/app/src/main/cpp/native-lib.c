...
Java_com_ethanco_ffmpegtest_MainActivity_stringFromJNI(JNIEnv *env, jobject instance) {
    return (*env)->NewStringUTF(env,"Hello from C");
}

//extern "C"
/*JNIEXPORT void JNICALL
Java_com_ethanco_ffmpegtest_VideoUtils_decode(JNIEnv *env, jclass type, jstring input_,
                                              jstring output_) {
